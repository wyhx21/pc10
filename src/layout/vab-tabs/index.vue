...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        visitedRoutes: 'appSetting/tagsBar/visitedRoutes',
      }),
    },
    watch: {
      $route: {
    ...
    methods: {
      ...mapActions({
        addVisitedRoute: 'appSetting/tagsBar/addVisitedRoute',
        delVisitedRoute: 'appSetting/tagsBar/delVisitedRoute',
        delOthersVisitedRoutes: 'appSetting/tagsBar/delOthersVisitedRoutes',
        delLeftVisitedRoutes: 'appSetting/tagsBar/delLeftVisitedRoutes',
        delRightVisitedRoutes: 'appSetting/tagsBar/delRightVisitedRoutes',
        delAllVisitedRoutes: 'appSetting/tagsBar/delAllVisitedRoutes',
      }),
