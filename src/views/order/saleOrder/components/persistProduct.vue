...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        supplier: 'appOrder/saleOrder/persist/supplier',
        productCode: 'appOrder/saleOrder/persist/param1',
        productName: 'appOrder/saleOrder/persist/param2',
        productList: 'appOrder/saleOrder/persist/productList',
    ...
    methods: {
      ...mapMutations({
        setProductCode: 'appOrder/saleOrder/persist/setParam1',
        setProductName: 'appOrder/saleOrder/persist/setParam2',
        setOrderProductList: 'appOrder/saleOrder/persist/setOrderProductList',
