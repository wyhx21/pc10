...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapMutations({
        updateProduct: 'appOrder/saleOrder/persist/updateProduct',
        updateProdRemark: 'appOrder/saleOrder/persist/updateProdRemark',
        deleteOrderProduct: 'appOrder/saleOrder/persist/deleteOrderProduct',
      }),
      updatePrice(price) {
