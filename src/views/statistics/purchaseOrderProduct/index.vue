...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        dataList: 'appStatistics/purchaseOrderProduct/dataList',
        perExport: 'appStatistics/purchaseOrderProduct/perExport',
        totalPageSize: 'appStatistics/purchaseOrderProduct/totalPageSize',
        currentPage: 'appStatistics/purchaseOrderProduct/pageInfo',
      }),
    },
    data() {
      return {
    ...
    methods: {
      ...mapMutations({
        pageInfo: 'appStatistics/purchaseOrderProduct/pageInfo',
        queryParam: 'appStatistics/purchaseOrderProduct/queryParam',
      }),
      ...mapActions({
        queryPage: 'appStatistics/purchaseOrderProduct/queryPage',
        exportData: 'appStatistics/purchaseOrderProduct/exportData',
      }),
      resetParam() {
        this.params = {
          statisticBegin: '',
