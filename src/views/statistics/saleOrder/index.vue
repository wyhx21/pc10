...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        dataList: 'appStatistics/saleOrder/dataList',
        perExport: 'appStatistics/saleOrder/perExport',
        totalPageSize: 'appStatistics/saleOrder/totalPageSize',
        currentPage: 'appStatistics/saleOrder/pageInfo',
      }),
    },
    data() {
      return {
    ...
    methods: {
      ...mapMutations({
        pageInfo: 'appStatistics/saleOrder/pageInfo',
        queryParam: 'appStatistics/saleOrder/queryParam',
      }),
      ...mapActions({
        queryPage: 'appStatistics/saleOrder/queryPage',
        exportData: 'appStatistics/saleOrder/exportData',
      }),
      resetParam() {
        this.params = {
          statisticBegin: '',
